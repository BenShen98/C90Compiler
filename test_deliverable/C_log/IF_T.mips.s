...
test_deliverable/C_log/IF_T.elf:     file format elf32-tradbigmips
...
00400110 <testif_t>:
  ...
  400124:	00000000 	nop
  400128:	11000008 	beqz	t0,40014c <ifEnd_0_testif_t>
  40012c:	00000000 	nop
  ...
  400144:	10000008 	b	400168 <EXIT_testif_t>
  400148:	00000000 	nop

0040014c <ifEnd_0_testif_t>:
  40014c:	24080006 	li	t0,6
  400150:	afa80028 	sw	t0,40(sp)
  400154:	8fa80028 	lw	t0,40(sp)
  400158:	00000000 	nop
  40015c:	01001025 	move	v0,t0
  400160:	10000001 	b	400168 <EXIT_testif_t>
  400164:	00000000 	nop

00400168 <EXIT_testif_t>:
