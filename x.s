...
lw $t1,72($sp) #load _1:40_ to$t1
nop
addiu $t1, $sp, 96 #addr of a
li $t2,2 #imm id _1:44_
li $t3,4 #imm id _1:48_
mult $t2,$t3 #cal offset _1:52
mflo $t4#cal offset _1:52
addu $t2,$t1,$t4 #dst id _1:56_
li $t4,5 #imm id _1:60_
sw $t0,108($sp) #write back id 1:4
sw $t1,72($sp) #write back id 1:40
sw $t2,56($sp) #write back id 1:56
